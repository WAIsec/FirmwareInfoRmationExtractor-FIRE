...
/* --------------------------------------------------------------------------- */
$check_lan = query("/runtime/stats/ethernet:2/tx/packets");
anchor("/wlan/inf:1");
...
function check_values()
{
	...
	if(f.e2w.value!="")
	{
		...
		if(f.e2w.value<1 || f.e2w.value >300)
		{
	...
	if(f.w2e.value!="")
	{
		...
		if(f.w2e.value<1 || f.w2e.value >300)
		{
			alert("<?=$a_invalid_range_for_speed ?>");
			f.w2e.select();
			return false;
      	  ...
      	  <legend><?=$m_uplink_interface?></legend>
				...
				<tr>
					<td width=35% id="td_left">
						<?=$m_downlink_bandwidth?><?=$m_range?>
					</td>
					<td>
						<input type="text" id="e2w" name="e2w" maxlength="3" size="6" value="<?=$cfg_e2w?>">Mbits/sec
					</td>
				</tr>
							
				<tr>
					<td width=35% id="td_left">
						<?=$m_uplink_bandwidth?><?=$m_range?>
					</td>
					<td>
						<input type="text" id="w2e" name="w2e" maxlength="3" size="6" value="<?=$cfg_w2e?>">Mbits/sec
					</td>
				</tr>

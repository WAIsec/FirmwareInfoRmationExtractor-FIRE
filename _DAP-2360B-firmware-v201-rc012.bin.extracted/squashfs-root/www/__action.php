...
else if($ACTION_POST == "st_ap")
{
	...
	if($f_detect == "1")
        {
              //  set("/wlan/inf:1/st_ap",1);//add for dennis to difference at apc scan or instruction scan
                if($cfg_ap_band == 0)
                {
                        set("/runtime/wlan/inf:1/st_ap",1);//add for dennis to difference at apc scan or instruction scan
                        $SUBMIT_STR="submit AP_SITESURVEY_G;submit COMP_G";
                	echo "<!-- g -->\n";
		}
                else if($cfg_ap_band == 1)
                {
                        set("/runtime/wlan/inf:2/st_ap",1);//add for dennis to difference at apc scan or instruction scan
...
else if($ACTION_POST == "st_logs")
{
        ...
        else if(query("/sys/log/logserver") != "")
        {
...
/*end 2009_4_2 sandy---------------------------------------------------------------*/
        ...
        if($SUBMIT_STR != "") {require("/www/cfg_valid.php");}

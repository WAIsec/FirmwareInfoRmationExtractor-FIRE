...
<? if(query("/wlan/inf:2/ap_mode") != "") {echo "<!--";} ?>
					<tr>
						<td width="25%"  id="td_left"><?=$m_average?></td>
						<td><?=$G_TAG_SCRIPT_START?>genSelect("averagetype", [1,4,3,2], ["<?=$m_averagetype_s?>","<?=$m_averagetype_fstation?>","<?=$m_averagetype_fw_g?>","<?=$m_averagetype_fssid?>"], "");<?=$G_TAG_SCRIPT_END?></td>
					</tr>
<? if(query("/wlan/inf:2/ap_mode") != "") {echo "-->";} ?>
      				<tr>

							...
							<tr>
								...
								<td id="td_right">
									...
									<select name="page_ntp_servers" id="page_ntp_servers">
										...
										<option value=<?=$cfg_dlink_ntp_server?>>ntp1.dlink.com</option>
									</select-->					
								</td>
							</tr>	
							<tr>

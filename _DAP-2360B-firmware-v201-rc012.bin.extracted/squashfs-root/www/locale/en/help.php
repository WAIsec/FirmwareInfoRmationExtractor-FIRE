...
if(query("/runtime/web/display/ack_timeout_range")=="0")
{
	if($check_band == "")
	{
		$adv_ack_timeout_msg="Specify an Ack Timeout value based on a range from 48-200 for 2.4GHz. This optimizes throughput over long disctance links. Ack Timeout is measured in microseconds(&micro;s). 48 &micro;s for 2.GHz.";
	}
	else
	{
...
if($check_band == "")
{
	$adv_mcast_rate_msg="Multicast rate adjusts multicast packet data rates. Multicast rate supports AP mode, Multi-SSID, and WDS with AP mode for 2.4GHz. When multicast rate is disabled, device will operate in suggested rate(11Mbps) and cannot be selected maually.";
}
else
{
	$adv_mcast_rate_msg="Multicast rate adjusts multicast packet data rates. Multicast rate supports AP mode, Multi-SSID, and WDS with AP mode for 2.4GHz and 5GHz. When multicast rate is disabled, device will operate in suggested rate(11Mbps for 2.4GHz and 6Mbps for 5GHz) and cannot be selected maually.";
}
...
$adv_auto_rssi_msg = "To lower RF interference, the Auto-RF option will decrease the receiving RF power of AP, but the RF power will not fall below this threshold value.";
...
$adv_local_password_msg = "The password fot the local rule.";
$adv_group = "Group";
...
$title_web_redirect_msg = "This function will redicte the URL to the specified web site. Click the option to enable this function.";
$adv_web_site = "Web Site";
...
$title_log_set_msg="Enter the Log server IP address. Click the checkboxes to monitor these parameters: System Activity, Wireless Activity, and Notices.";
...
$mt_upload_language_msg = "Download the SSL Certificate, click Browse, select the downloaded certificate, click Open then Upload to complete the upgrade process.";

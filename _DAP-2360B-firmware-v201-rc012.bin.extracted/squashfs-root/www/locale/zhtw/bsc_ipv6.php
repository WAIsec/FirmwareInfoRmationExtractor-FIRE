...
$a_enable_ipv6 = "If enable ipv6, AP Array, QoS, Traffic manager and Internal Radius Server will set to disabled; AP Client will set to Access Point.";
$a_enable_ipv6_2690 = "If enable ipv6, AP Array, QoS and Traffic manager will set to disabled; AP Client will set to Access Point.";
?>

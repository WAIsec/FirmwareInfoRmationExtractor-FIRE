...
else if($ACTION_POST == "adv_resource")
{
	...
	if($preferred_5g == 1)
	{
		...
		/*
		if(query("/sys/wlan/pre5g_rssi")!=$preferred_rssi_5g)
		{
			set("/sys/wlan/pre5g_rssi",$preferred_rssi_5g);
			$dirty++;
		}		
		*/
	}
...
else if($ACTION_POST == "adv_updnsetting")
{
	...
	{	
		...
		set("/runtime/web/submit/commit",1);
		//set("/runtime/web/submit/qos_tm",1);
...
else if($ACTION_POST == "adv_8021q")
{
	...
	if($f_vlan == 1)
	{
		...
		//if(query("/wlan/inf:1/ap_mode")==0 || query("/wlan/inf:1/ap_mode")==3)
		//{
		//	set("/wlan/inf:1/multi/state",	1);	
		//	$dirty_wlan++;
		//}
		//if(query("/wlan/inf:2/ap_mode")==0 || query("/wlan/inf:2/ap_mode")==3)
		//{
		//	set("/wlan/inf:2/multi/state",	1);	
		//	$dirty_wlan++;
		//}
...
/*		else if($encry_type == 5)
		{
			set("/captival/auth:5/state", 1);$dirty++;
		}
		else if($encry_type == 6)
		{
			set("/captival/auth:6/state", 1);$dirty++;
		}*/
...
//		if(query("arrayauth")  !=$arrayauth) {set("arrayauth", $arrayauth);   $dirty++;}
